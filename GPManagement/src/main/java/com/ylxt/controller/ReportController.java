...
public class ReportController {
    ...
    public ServerResponse<List<StartReport>> refreshAuditList(HttpSession session) {
        ...
        ServerResponse<List<StartReport>> response = reportService.refreshAuditList(user.getUsername());
